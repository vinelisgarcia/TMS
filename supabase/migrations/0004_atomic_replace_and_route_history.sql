...
begin
  ...
  if p_table_name = 'tms_user_profiles' then
    ...
    delete from public.tms_route_configs where true;
    ...
    delete from public.tms_client_configs where true;
    ...
    delete from public.tms_order_lines where true;
    ...
    delete from public.tms_route_cost_history where true;
    ...
    delete from public.tms_warehouse_plan where true;
    ...
    delete from public.tms_warehouse_control where true;
    ...
    delete from public.tms_warehouse_history where true;
